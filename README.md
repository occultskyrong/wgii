...
- [4. 目录结构](#4-目录结构)
    ...
    - [4.2. 生成](#42-生成)
    - [4.3. 目录树](#43-目录树)
    - [4.4. `/dist` 目录结构](#44-dist-目录结构)
        - [4.4.1. `/dist/CHN` 目录结构](#441-distchn-目录结构)
        - [4.4.2. `/dist` 其他国家目录结构](#442-dist-其他国家目录结构)
- [5. 开发者信息](#5-开发者信息)
    - [5.1. Build](#51-build)
    - [5.2. Changes](#52-changes)
    - [5.3. Todo list](#53-todo-list)
    - [5.4. Contributions](#54-contributions)
- [6. 参考](#6-参考)
...
```tree
.
├── country.resource.geo.json                               # 该国家原始数据，具体数据来源下 数据来源
