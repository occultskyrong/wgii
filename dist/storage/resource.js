...
export class Resource {
     ...
     */
    static async loadCountryGeoJson() {
     ...
     * @returns GeoJSON FeatureCollection
     */
    static async loadWorldCountryJson() {
     ...
     * @returns 国家信息列表
     */
    static async loadCountriesInfo() {
     ...
     */
    static async saveCountriesInfo(countries) {
        const filePath = JsonStore.getDistPath(this.PATHS.countriesInfo);
        const data = {
            countries,
     ...
     */
    static async loadUNCountriesEnglish() {
     ...
     */
    static async loadCountryCenterPoints() {
     ...
     * @returns 中心点映射（国家名 -> 坐标）
     */
    static async loadOriginalCountryCenterPoints() {
     ...
     */
    static async loadCountryTranslation() {
     ...
     * @returns 翻译映射（英文名 -> 中文名）
     */
    static async loadOriginalCountryTranslation() {
     ...
     */
    static async saveCountryGeoJson(data, fileName = 'countries.geojson') {
     ...
     * @returns 是否存在
     */
    static async hasGeneratedGeoJson() {
        const filePath = JsonStore.getDistPath(this.PATHS.generatedGeoJson);
