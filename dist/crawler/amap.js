...
export class AmapCrawler {
     ...
     */
    async getDistrict(adcode = '100000', extensions = 'all') {
        if (!this.apiKey) {
            await this.init();
        }
     ...
     */
    processDistrictRecursive(district, features) {
     ...
     */
    async generateChinaGeoJSON(adcode = '100000', subdistricts = 3) {
     ...
     */
    async getProvinceDetail(adcode) {
